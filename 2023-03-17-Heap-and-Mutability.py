...
############## Code Part 2
# def function2(a: List[int]) -> List[int]:
#     a.append(7)
#     return a
#
#
...
# Change something in the Heap, and you have changed it for *all*
# variables which point to it!!

# Simple Heap Tracing Examples -- The solution is posted here:
# https://hendrix-my.sharepoint.com/:b:/g/personal/seme_hendrix_edu/EVmzyxn7SsxAiRvCAxE-zm0BAAFWCpy6C-FSYeDpRCmlYA?e=rhvKRu
