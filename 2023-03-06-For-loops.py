...
### Solutions are also posted, in the 'Calendar' section,
### under this coming Friday's notes

# Remember that how have list and while loop based
# CodingBat homework due on Wednesday
...
def excite(lst: List[str]) -> List[str]:
    ...
    return new_list
# it is important to add the new variable "new_list", so the input doesn't get overwritten.
