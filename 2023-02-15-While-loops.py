...
# This is our first real use of PyCharm in class
# Unlike Kaggle, it does not really have a cell structure
#  the whole file runs (or not)
# We do not have markdown cells -- instead, I will use
# comments (the '#' character) to make explanations and such
