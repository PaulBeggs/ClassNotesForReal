# Reminders:
#
# Homework #5 due on Wednesday (CodingBat)
#
# Project #1 due on Friday -- do not forget the reflection part!!
...
# Always avoid having lists where the entries are multiple data types.
...
# print(my_list[1])
# print(my_list[1:2])
# List of a single index is the value of that data type. For example, my_list[n] will return a result without '[]'s.
# Inversely, my_list[n:m] will always return a list.
# print(my_list[1:4])
...
# returns False
# print([3,5] in [[3,5],7,8])
# returns True, because "[3,5]" is specifically located in the list.
# the order matters in a list. For example, "[3,5]" is different than "[5,3]".
...
# my_list.append(888)
# ".append" = add additional values into the list.
# print(my_list)
...
#
# print(len([[3, 5], 7, 8]))
# Because "[3,5]" is an entry that is a part of the overall list, thus lens() will return 3 in this case.
