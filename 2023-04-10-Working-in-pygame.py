...
####################################### Important!!!!!!!!!######
# The current version of pygame seems to have a bug
# If you try to draw a circle with its x-coordinate of the center < 0,
# you get a long horizontal rectangle instead.

# THis will not be a problem if it happens to you, but you can fix it by:
# Click on the bottom right of your screen where it says: Python 3.11
# Open up the Interpreter Setting Menu
# Click on pygame
# On the bottom right, click the box that says 'Specify Version'
# Choose 2.2.0 as the version.
...
#######
# In class, we assigned Project #3 today
# The Design Document is due on Monday next week
# See my sample, linked on the class calendar

# I also showed a few examples of past projects
...
## Let's start simple -- we are going to make some circles and rectangles, and then have them move
