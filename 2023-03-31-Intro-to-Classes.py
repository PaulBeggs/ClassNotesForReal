...
# Reminders:
#   New Homework -- on Tracing with the Heap, Dictionaries, and Lists due Wed, 4/8
#
...
# Before starting *today's* topic, we jumped back to Wednesday and I talked about
# the zipcode example at the bottom of that day's code
...
# other functions -- like all of the fun1(), aaa() that
# I write in heap tracing, etc
...
#  my wife's Honda Odyssey, or my older daughter's Accord
#  (notice a theme with out family....)
...
#
# Solution at:
# https://hendrix-my.sharepoint.com/:b:/g/personal/seme_hendrix_edu/EfUvdTxHYDtAlgvrJXKKnFcB8qs9FMvVW9pl9-HCf_Mfsg?e=i4Llr2
